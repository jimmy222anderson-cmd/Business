  ...
  sections: [
    {
      ...
      content: "By accessing or using the Earth Observation Platform ('Platform', 'Service', 'we', 'our', or 'us'), you agree to be bound by these Terms of Service ('Terms'). If you do not agree to these Terms, you may not access or use the Platform.\n\nThese Terms constitute a legally binding agreement between you (whether personally or on behalf of an entity) and Earth Observation Platform. We reserve the right to modify these Terms at any time, and your continued use of the Platform constitutes acceptance of any changes.\n\nIf you are using the Platform on behalf of an organization, you represent and warrant that you have the authority to bind that organization to these Terms."
    },
    {
      id: 'description',
