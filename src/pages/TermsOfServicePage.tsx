...
import { getTermsOfService, type ContentSection } from '@/lib/api/content';
import { Alert, AlertDescription } from '@/components/ui/alert';

// Terms section interface (now using ContentSection from API)
  ...
  useEffect(() => {
    async function fetchContent() {
      try {
        ...
        // Convert API sections to TermsSection format
        const convertedSections: TermsSection[] = data.sections.map((section: ContentSection) => ({
          id: section.id,
          title: section.title,
