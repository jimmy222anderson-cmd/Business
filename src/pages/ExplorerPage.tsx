...
export default function ExplorerPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Satellite Imagery Explorer | Earth Intelligence Platform</title>
        <meta 
          name="description" 
        ...
        <meta property="og:title" content="Satellite Imagery Explorer | Earth Intelligence Platform" />
        <meta 
        ...
        <meta name="twitter:title" content="Satellite Imagery Explorer | Earth Intelligence Platform" />
        <meta 
